					...
					>
						...
						<div className="container mt-10 text-black">
							<h3 className="text-sm font-black text-[#1e1e1e] md:text-base">
								{locale === "ru" ? "ПОПУЛЯРНЫЕ АВТОМОБИЛИ" : "CARS TO ORDER"}
							</h3>
									...
									>
										...
										>
											...
											<div className={"mt-5 grid w-full grid-cols-2 gap-y-4"}>
												...
												>
													<Image
														src={"/carstoorder/acceleration.svg"}
														alt={"Battery"}
														width={20}
														height={20}
													/>
												...
												>
													...
													/>
													<span>
														{getPrivod(locale, item.attributes?.privod)}
													</span>
												</div>
											</div>
											<div className={"mt-7 w-full"}>
												<ModalTrigger
													...
													label={locale === "ru" ? "Подробнее" : "More details"}
